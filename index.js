//Declares the variable 'finances' based on the provided dataset:
var finances = [
    ['Jan-2010', 867884],
    ['Feb-2010', 984655],
    ['Mar-2010', 322013],
...
//Defines the function financialAnalysis and declare the variables :
function financialAnalysis(finances) {
  ...
  for (var i = 0; i < finances.length; i++) {
    ...
    totalProfitLoss += profitLoss;
     ...
     // Calculates changes in Profit/Losses
    if (i > 0) {
  ...
  var averageChange = totalChange / (totalMonths - 1); // Taking away 1 from totalMonths as changes start from the second month
  ...
  console.log("Average Change: $", averageChange.toFixed(2)); // toFixed(2) specifies 2 decimal places
  console.log("Greatest Increase in Profits/Losses:", greatestIncrease.month, "($", greatestIncrease.amount, ")"); // concatenates mixed data types - string and integer
  console.log("Greatest Decrease in Profits/Losses:", greatestDecrease.month, "($", greatestDecrease.amount, ")");
}

// Executes the whole function with the dataset:
